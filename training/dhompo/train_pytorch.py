...
Usage
-----
    python training/dhompo/train_pytorch.py
    python training/dhompo/train_pytorch.py --config configs/dhompo/lstm_model.yaml --epochs 100
"""
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--config", default="configs/dhompo/lstm_model.yaml")
    p.add_argument("--train-config", default="configs/dhompo/training.yaml")
