...
export type StationSnapshot = StationGeo & { dataMode: "live" | "simulation"; valueM: number; delta3hM: number; status: StationStatus; alertM: number; dangerM: number; color: string; rainfall30mMm: number; rainfall24hMm: number; quality: WaterQualityReading };
...
export type LayerKey = "topology" | "surabayaRivers" | "regionalRivers" | "subdas" | "labels" | "basin" | "admin" | "rainfall" | "quality" | "relief";
export type RegionKey = "jawa-timur" | "welang" | "surabaya";
